...
in the journal _BMC Medical Imaging_ (available as open access here: https://www.biomedcentral.com/1471-2342/15/29)
provides definitions and a comprehensive analysis of these metrics as well as guidelines
for metric selection based on the properties of the segmentations being evaluated and the
segmentation goal.
...
## Evaluation of volume segmentations
...
## Evaluation of landmark localization
